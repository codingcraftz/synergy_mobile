...
const Information = () => {
	return (
		<div className="flex flex-col items-center font-sans">
			...
			<section className="flex flex-col gap-2 text-sm p-4 text-center font-sans py-6 items-start">
				<div className="flex gap-2 items-center">
					<p className="bg-orange-400 rounded-lg px-2 text-white">특별강의</p>
					<p className="text-md">15:00 ~ 17:00</p>
				</div>
				<p className="text-md">손해사정사도 모르는 실전 숨은 보험금 마스터파일</p>
